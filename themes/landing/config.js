const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/askofcc/FeishuNext',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://github.com/askofcc/FeishuNext',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'FeishuNext',
  LANDING_HERO_P_1: '快速搭建独立站、轻松放大品牌价值！',
  LANDING_HERO_BUTTON_1_TEXT: '开始体验',
  LANDING_HERO_BUTTON_1_LINK: 'https://github.com/askofcc/FeishuNext',
  LANDING_HERO_BUTTON_2_TEXT: '了解更多',
  LANDING_HERO_BUTTON_2_LINK: 'https://github.com/askofcc/FeishuNext',
  ...
  LANDING_FEATURES_BLOCK_6_P: 'FeishuNext，助您把飞书内容发布成站',
  ...
  LANDING_TESTIMONIALS_SOCIAL_URL: 'https://github.com/askofcc/FeishuNext',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://github.com/askofcc/FeishuNext', // 重定向网站地址

  LANDING_PRICING_TITLE: '价格表',
  LANDING_PRICING_P: 'FeishuNext 开源；此处仅演示订阅区块，请勿购买！',
  ...
  LANDING_PRICING_1_URL: 'https://github.com/askofcc/FeishuNext',
  ...
  LANDING_PRICING_2_URL: 'https://github.com/askofcc/FeishuNext',
  ...
  LANDING_PRICING_3_URL: 'https://github.com/askofcc/FeishuNext',

  LANDING_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_LANDING_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://github.com/askofcc/FeishuNext
}
