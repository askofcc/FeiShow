...
// Compatibility aliases for partially-synced endspace components
export const buildMenuItems = getEndspaceMenuItems
export const isMenuItemActive = (item, currentPath) => {
  const items = item ? [item] : []
  // reuse path matching via active name helper when possible
