  ...
  <footer className='opc-footer px-5 pb-8 text-xs md:px-10'>
    <div className='mx-auto flex max-w-6xl flex-col gap-2 border-t pt-5 sm:flex-row sm:items-center sm:justify-between'>
      <div className='opc-muted'>
        由 <SmartLink href='https://github.com/askofcc/FeiShow'>FeiShow</SmartLink> 驱动 · 主题 OPC
      </div>
      <div className='flex flex-wrap gap-3'>
        <SmartLink href='https://github.com/askofcc/FeiShow'>FeiShow 仓库</SmartLink>
        <SmartLink href='https://github.com/askofcc/FeiShow'>项目文档</SmartLink>
      </div>
    </div>
  </footer>
)
