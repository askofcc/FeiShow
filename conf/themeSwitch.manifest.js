...
export const THEME_SWITCH_MANIFEST = {
  ...
  opc: {
    ...
    settings: [
      ...
      { key: 'OPC_PRIMARY_TEXT', label: '主按钮文字', type: 'text', defaultValue: '查看 FeishuNext' },
      { key: 'OPC_PRIMARY_URL', label: '主按钮链接', type: 'text', defaultValue: 'https://github.com/askofcc/FeishuNext' },
      { key: 'OPC_SECONDARY_TEXT', label: '副按钮文字', type: 'text', defaultValue: '阅读长期记录' },
      { key: 'OPC_SECONDARY_URL', label: '副按钮链接', type: 'text', defaultValue: 'https://github.com/askofcc/FeishuNext' },
